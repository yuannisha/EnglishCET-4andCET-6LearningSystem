...
function populateParameters(fromRes, toRes) {
  ...
  const parameters = {
    appId: "__UNI__0FCBB2C",
    appName: "EnglishCET-4andCET-6LearningSystem",
    appVersion: "1.0.0",
    appVersionCode: "100",
...
function initRuntimeSocketService() {
  const hosts = "192.168.110.25,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_3X6iuv";
...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "写作练习"
    }
  },
  {
    path: "pages/translation/translation",
    style: {
      navigationBarTitleText: "翻译练习"
    }
  }
];
const globalStyle = {
  navigationBarTextStyle: "white",
  navigationBarTitleText: "四六级学习",
